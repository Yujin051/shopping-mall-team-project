...
public class ShopProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		itemRepository.save(new Item("게임1", 50000, 99, "상세설명1", "게임", "액션, 어드벤처, RPG/롤플레잉", "", "" ));
		itemRepository.save(new Item("게임2", 50000, 99, "상세설명2", "게임", "액션, FPS/슈팅", "", "" ));
		itemRepository.save(new Item("게임3", 50000, 10, "상세설명3", "게임", "스포츠", "", "" ));
		itemRepository.save(new Item("게임4", 50000, 99, "상세설명4", "게임", "파티, 아케이드", "", "" ));
		itemRepository.save(new Item("게임5", 50000, 99, "상세설명5", "게임", "전략", "", "" ));
		itemRepository.save(new Item("게임6", 50000, 99, "상세설명6", "게임", "음악", "", "" ));
		itemRepository.save(new Item("게임7", 50000, 99, "상세설명7", "게임", "격투, 트레이닝", "", "" ));
		itemRepository.save(new Item("게임8", 50000, 99, "상세설명8", "게임", "FPS/슈팅, 아케이드", "", "" ));
		itemRepository.save(new Item("게임9", 50000, 99, "상세설명9", "게임", "액션, 어드벤처", "", "" ));
		itemRepository.save(new Item("게임10", 50000, 99, "상세설명10", "게임", "RPG/롤플레잉, 전략", "", "" ));
		itemRepository.save(new Item("게임11", 50000, 99, "상세설명11", "게임", "RPG/롤플레잉, 전략", "", "" ));
		itemRepository.save(new Item("게임12", 50000, 99, "상세설명12", "게임", "액션, 어드벤처", "", "" ));
		itemRepository.save(new Item("게임13", 50000, 99, "상세설명13", "게임", "FPS/슈팅, PRG/롤플레잉", "", "" ));
		itemRepository.save(new Item("게임14", 50000, 99, "상세설명14", "게임", "FPS/슈팅, RPG/롤플레잉", "", "" ));
		itemRepository.save(new Item("게임15", 50000, 99, "상세설명15", "게임", "어드벤처, RPG/롤플레잉", "", "" ));
	}
